...
export default function CentresPage() {
  ...
  // Filters + Pagination
  const filteredCentres = centres.filter((u) => {
  ...
  const paginatedUsers = filteredCentres.slice(startIndex, startIndex + rowsPerPage);
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex justify-between items-center mt-4">
        <div className="text-sm text-gray-600">
          Showing {startIndex + 1}–{Math.min(startIndex + rowsPerPage, filteredCentres.length)} of {filteredCentres.length} users
        </div>
