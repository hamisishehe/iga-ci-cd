...
>
  ...
  <div className="md:col-span-2 flex items-end">
    <Button className="w-full h-11 rounded-xl" onClick={addExpense}>Save</Button>
  </div>
  ...
  <tbody className="divide-y divide-gray-200">
    {expenses.length > 0 ? expenses.map((exp, i) => (
      <tr key={i} className="hover:bg-gray-50">
        ...
        <td className="px-4 py-2">{formatNumber(exp.amount)}  TSH</td>
      ...
      <tr>
        <td className="px-4 py-2 text-center" colSpan={5}>No expenditures added</td>
      </tr>
    )}
  </tbody>
</table>
             ...
             <Button  onClick={exportExcel} className="md:col-span-1 bg-green-500 m-3.5">Export Excel</Button>
        </CardContent>
      </Card>
    </div>
  );
